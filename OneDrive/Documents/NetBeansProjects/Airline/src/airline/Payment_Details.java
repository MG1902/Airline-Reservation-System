...
public class Payment_Details extends JFrame{ //Fifth
	...
	label = new JLabel("");
	label.setIcon(new ImageIcon(getClass().getResource("/Images/payment.png")));
	...
	Show.addActionListener(new ActionListener(){
            public void actionPerformed(ActionEvent ae){
                ...
                try {
                    ...
                    Conn c = new Conn();
                    String str = "select pnr_no,paid_amt,pay_date,cheque_no,card_no,ph_no from APP.payment where pnr_no = '"+code+"'";
