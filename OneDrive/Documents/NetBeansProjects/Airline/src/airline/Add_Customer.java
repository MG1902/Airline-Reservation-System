...
public class Add_Customer extends JFrame{ //Third Frame
	JTextField textField,textField_1,textField_2,textField_3,textField_4,textField_5,textField_6;
        ...
        public Add_Customer(){
            ...
            ImageIcon i1 = new ImageIcon(getClass().getResource("/Images/emp.png"));
            ...
            Next.addActionListener(new ActionListener(){
                public void actionPerformed(ActionEvent ae){
                    ...
                    try {
                       Conn c = new Conn();
                        String str = "INSERT INTO APP.passenger values( '"+pnr_no+"', '"+address+"', '"+nationality+"','"+name+"', '"+gender+"', '"+ph_no+"','"+passport_No+"', '"+fl_code+"')";
